# WIP_A module market for Contract wallet

作成日時: 2023-05-04 14:06:56
更新日時: 2024-02-10 04:55:49
...
>dApps will penetrate into Wallet UX. Modules can abstract dApp experience.
 ...
 CWはコントラクトの性質上、機能拡張をしやすいようにモジュール型のアーキテクチャを採用している
 	...
 	![6453fd2db5282c52c449e13d.png](./img/6453fd2db5282c52c449e13d.png) ![6453fd363654c76d6f6fce85.png](./img/6453fd363654c76d6f6fce85.png) ![6453fd4b3c9ba4093107ab46.png](./img/6453fd4b3c9ba4093107ab46.png)
 	![65c747fc22b03800245d6989.png](./img/65c747fc22b03800245d6989.png)
 	![65c74804a116370026d38f08.png](./img/65c74804a116370026d38f08.png)
![65c74823e0b46500257f2c00.png](./img/65c74823e0b46500257f2c00.png)
 ...
 moduleの扱い方の規格化をしたい
 	...
 	Argent
 		...
 		moduleが最初のタッチポイントなので、basewalletに検証機能のIFとロジックを実装し、moduleでIFを採用して検証しなければいけない？
 			argentは、moduleとbasewalletを機能的に独立させることを目指しているため、moduleがbasewalletの仕様に依存してしまうのは本来の設計上相性が悪いのでは[0xhid3.icon]
 	unWallet
 ...
 自分のビジョンとしては、アプリケーションは、dApp本体とmoduleを提供する
 	乱立するWallet戦争を波乗りする
 	![6458840072a971c2ae58368a.png](./img/6458840072a971c2ae58368a.png)
      - Module market
　Module market の萌芽
　	backpackのxNFT
　	![6453ff48ebf7044a3d42ff9a.png](./img/6453ff48ebf7044a3d42ff9a.png)
